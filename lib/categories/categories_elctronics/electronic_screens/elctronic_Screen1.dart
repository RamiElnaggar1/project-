...
class ElectronicScreen1 extends StatefulWidget {
  @override
  _ElectronicScreen1State createState() => _ElectronicScreen1State();
}

class _ElectronicScreen1State extends State<ElectronicScreen1> {
  int add;
