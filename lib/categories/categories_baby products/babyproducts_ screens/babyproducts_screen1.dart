...
class BabyProductsScreen1 extends StatefulWidget {
  @override
  _BabyProductsScreen1State createState() => _BabyProductsScreen1State();
}

class _BabyProductsScreen1State extends State<BabyProductsScreen1> {
  int add;
