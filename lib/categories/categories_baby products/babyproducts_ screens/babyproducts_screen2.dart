...
class BabyProductsScreen2 extends StatefulWidget {
  @override
  _BabyProductsScreen2State createState() => _BabyProductsScreen2State();
}

class _BabyProductsScreen2State extends State<BabyProductsScreen2> {
  int add;
