...
class SupermarketScreen1 extends StatefulWidget {
  @override
  _SupermarketScreen1State createState() => _SupermarketScreen1State();
}

class _SupermarketScreen1State extends State<SupermarketScreen1> {
  int add;
