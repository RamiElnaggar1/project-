...
class FashionScreen2 extends StatefulWidget {
  @override
  _FashionScreen2State createState() => _FashionScreen2State();
}

class _FashionScreen2State extends State<FashionScreen2> {
  int add;
