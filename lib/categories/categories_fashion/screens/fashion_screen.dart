...
class FashionScreen4 extends StatefulWidget {
  @override
  _FashionScreen4State createState() => _FashionScreen4State();
}

class _FashionScreen4State extends State<FashionScreen4> {
  int add;
